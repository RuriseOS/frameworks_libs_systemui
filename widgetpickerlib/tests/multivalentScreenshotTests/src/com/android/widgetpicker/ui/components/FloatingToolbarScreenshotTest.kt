...
import com.android.widgetpicker.goldenpathmanager.WidgetPickerLibGoldenPathManager
...
class FloatingToolbarScreenshotTest(emulationSpec: DeviceEmulationSpec) {
    ...
    val screenshotRule =
        ComposeScreenshotTestRule(
            emulationSpec,
            WidgetPickerLibGoldenPathManager(getEmulatedDevicePathConfig(emulationSpec)),
        )
