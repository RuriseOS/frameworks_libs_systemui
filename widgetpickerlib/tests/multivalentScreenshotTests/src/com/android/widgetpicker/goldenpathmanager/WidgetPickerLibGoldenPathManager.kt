...
package com.android.widgetpicker.goldenpathmanager
 ...
 */
class WidgetPickerLibGoldenPathManager(pathConfig: PathConfig) :
    GoldenPathManager(
    ...
    private companion object {
        private const val ASSETS_PATH =
            "frameworks/libs/systemui/widgetpickerlib/tests/multivalentScreenshotTests/assets/widgetpicker_screenshots"
        private const val ASSETS_PATH_ROBO =
            "frameworks/libs/systemui/widgetpickerlib/tests/multivalentScreenshotTests/assets/widgetpicker_screenshots_robolectric"
